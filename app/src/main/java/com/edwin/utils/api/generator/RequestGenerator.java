package com.edwin.utils.api.generator;
...
public class RequestGenerator {
    ...
    private static File httpCacheDirectory = new File(EdwinApplication.Companion.getContext().getCacheDir(), "httpCache");
    ...
    public static void setHttpCacheDirectory(String name) {
        httpCacheDirectory = new File(EdwinApplication.Companion.getContext().getCacheDir(), name);
    }
